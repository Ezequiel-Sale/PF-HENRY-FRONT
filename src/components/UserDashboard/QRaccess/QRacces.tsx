    ...
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetContent className="bg-black text-white overflow-y-auto">
          <SheetHeader>
            <SheetTitle className="text-white">Activar Suscripción</SheetTitle>
          </SheetHeader>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Plan (días por semana)</FormLabel>
                    <FormControl>
                      <select {...field} className="w-full bg-gray-700 text-white p-2 rounded">
              ...
              <div className="flex flex-col space-y-2">
                <label className="text-xl">Selecciona método de pago</label>
                <div className="flex space-x-4 justify-center">
                  <div className="flex items-center">
                    ...
                    <label
                      ...
                      className={`flex flex-col rounded-md border p-2 items-center cursor-pointer space-x-2 w-28
                        ${selectedPaymentMethod === "efectivo" && "border-red-500"}`}
                    >
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <label
                      htmlFor="MercadoPago"
                      className={`flex flex-col rounded-md border p-2 items-center cursor-pointer space-x-2 w-28
                        ${selectedPaymentMethod === "MercadoPago" && "border-red-500"}`}
                    >
                      <SiMercadopago className="text-blue-400" size={30} />
                      <p className="text-sm">MercadoPago</p>
                    </label>
                  </div>
                </div>
              </div>
              <Button type="submit" className="w-full bg-red-500 text-white">Activar Suscripción</Button>
            </form>
          </Form>
        </SheetContent>
      </Sheet>
